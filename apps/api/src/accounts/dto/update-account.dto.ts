...
import { AccountType, ACCOUNT_NAME_MAX_LENGTH } from '@wardkeep/shared';
...
export const UpdateAccountSchema = z.object({
  ...
  initialBalance: z
    ...
    .optional(),
  creditLimit: z.string().regex(/^\d+(\.\d+)?$/, 'Credit limit must be a valid decimal string').nullable().optional(),
});
