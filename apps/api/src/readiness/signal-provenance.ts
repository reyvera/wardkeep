...
const PROVENANCE_BY_CAPABILITY: Record<string, SignalProvenance> = {
  ...
  'fixed-obligations': { sources: ['Recorded debt profiles', 'Confirmed recurring bills', 'Liquid account balances'], method: 'Compares recorded monthly debt minimums and confirmed recurring bills with liquid reserves.', limitation: 'Unrecorded bills, variable obligations, and income are not included.', evidenceState: 'mixed' },
