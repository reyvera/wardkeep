...
export default function HouseholdTransitionsPage() {
  ...
  return <div className="space-y-6">
    ...
    <section className="card" aria-labelledby="record-check-heading">
      <div className="flex items-start justify-between gap-3"><div><h2 id="record-check-heading" className="card-title mb-1">RECORD CHECK</h2><p className="text-sm text-content-secondary">{readiness.data ? `${readiness.data.recordedCount} of ${readiness.data.totalCount} record groups are present.` : 'Checking recorded household information…'}</p></div></div>
