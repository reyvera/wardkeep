...
| Command center         | Partial     | Pillar explanations, a visit-aware change feed, capability-specific next-action links, and durable recommendation actions are in place; Coming Up and impact previews remain                                                            |
