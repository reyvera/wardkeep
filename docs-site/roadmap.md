...
| Command center         | Partial     | Pillar explanations, a visit-aware change feed, capability-specific next-action links, and durable recommendation records are in place; Coming Up, recommendation UI, and impact previews remain                                        |
