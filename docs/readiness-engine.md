...
- Daily snapshots preserve overall and pillar score history as well as the contributing signals. The readiness response includes up to 90 available daily snapshots; the dashboard labels score movement with the actual elapsed days represented and only shows an overall trend for a sufficiently complete assessment.
