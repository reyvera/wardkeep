...
A future Household Transition workspace will support two distinct workflows: an incapacity continuity plan for a living household member, and an after-death settlement plan for survivors. It will help a surviving spouse or another explicitly invited trusted person work through recorded accounts, policies, document locations, recurring obligations, and user-entered arrangement checklists. It may include optional funeral or memorial planning checklists and prompts to contact appropriate professionals. Wardkeep will not determine whether someone is incapacitated or deceased, validate an executor, personal representative, or power of attorney, bypass authentication, grant access from a recorded designation, or provide legal, tax, medical, financial, or funeral-direction advice. Any trusted-person access must be separately invited, approved, scoped, revocable, and auditable. The future workflow will store locations and notes by default—not sensitive document contents—and death or access status will never itself change a readiness score. It will never automatically release information due to inactivity or a reported death.
