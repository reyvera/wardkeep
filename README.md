...
- **Encrypted backups and recovery** — Manual AES-256-GCM backups with a user passphrase, optional scheduled deployment-local backups, paired off-site encrypted copies, and in-app restore controls
