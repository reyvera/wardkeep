...
const PAGES = [
  ...
  { name: 'home-maintenance', path: '/home-maintenance' },
  { name: 'emergency-preparedness', path: '/emergency-preparedness' },
  { name: 'household-transitions', path: '/household-transitions' },
  { name: 'debt', path: '/debt' },
